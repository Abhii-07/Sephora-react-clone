...
export const ProductDetails = () => {
  const details = JSON.parse(localStorage.getItem("hair-cart")) || [];
  const data = [
    {
  ...
  const makeupCartData = JSON.parse(localStorage.getItem("makeup-cart")) || [];
  const handleStorage = () => {
    makeupCartData.push(details[0]);
    localStorage.setItem("makeup-cart", JSON.stringify(makeupCartData));
  };
